...
const ExpenseEditPage : FunctionComponent = () => {
    ...
    const [createExpense, { loading: createLoading }] = useCreateExpenseMutation();
    const [updateExpense, { loading: updateLoading }] = useUpdateExpenseMutation();
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <Form.Group className='mb-3' controlId='formBasicCheckbox'>
                    <Form.Check
                        ...
                        checked={paid}
                        onChange={(event) => {
                            setPaid(Boolean(event.target.value));
                        }}
                    />
                </Form.Group>
